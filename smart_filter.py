...
class SmartFilter:
    ...
    def start_tcp_server(self):
        ...
        print(f"SmartFilter iniciado no endereço: {self.server_socket.getsockname()}")
...
if __name__ == "__main__":
    filter_device = SmartFilter("filter01", "off")
    filter_device.start_device()
    print("Dispositivo SmartFilter foi iniciado.")
