...
class SmartLamp:
    ...
    def start_tcp_server(self):
        ...
        print(f"SmartLamp iniciado no endereço: {self.server_socket.getsockname()}")
...
if __name__ == "__main__":
    lamp = SmartLamp("lamp01", "off")
    lamp.start_device()
    print("Dispositivo SmartLamp foi iniciado.")
